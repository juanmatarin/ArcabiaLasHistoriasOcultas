namespace ArcabiaLasHistoriasOcultas.Clases
{
    public class Opcion
    {
        ...
        public Opcion(int id, int idActo, string descripcion, string ruta, string tipo, string descripcionOpcion,
            int siguienteActo, bool decisionCondicionante, bool decisionElegida, int decisionAConsiderarActo, int decisionAConsiderarOpcion, int opcionAMostrar,string contenidoHTML)
        {
            this.id = id;
            this.idActo = idActo;
            this.descripcion = descripcion;
